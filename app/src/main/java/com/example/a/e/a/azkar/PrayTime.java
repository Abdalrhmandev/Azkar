...
/**
 * Created by AEADevDoc on 07/02/2017.
 */
...
// Time Names
        ...
        timeNames.add("الْفَجْرُ");
        timeNames.add("الشُّرُوقُ");
        timeNames.add("الظُّهْرُ");
        timeNames.add("الْعَصْرُ");
        timeNames.add("الْغُرُوبُ");
        timeNames.add("الْمَغْرِبُ");
        timeNames.add("الْعَشَاءُ");
