...
public class MorningAzkarActivity extends AppCompatActivity {
    ...
    public List getData(){
        ...
        String[] mormAzkar = {"يبدأ بعد طلوع الفجر ، واختلفوا في نهايته على ثلاثة أقوال : \n" +
                "\n" +
        ...
        String [] morfadl = {"تنيه بموعد اذكارالصباح",
                "فضل الذكر : من قالها حين يصبح أجير من الجن حتى يمسى ومن قالها حين يمسى أجير من الجن حتى يصبح ",
                "فضل الذكر : من قرأ سور الاخلاص و الفلق و الناس حين يصبح كفته من كل شىء",
                "فضل الذكر : من قرأ سور الاخلاص و الفلق و الناس حين يصبح كفته من كل شىء",
                "فضل الذكر : من قرأ سور الاخلاص و الفلق و الناس حين يصبح كفته من كل شىء",
                "فضل الذكر : من اذكار الصباح",
                "فضل الذكر : من قالها موقنا بها حين يمسى ومات من ليلته دخل الجنة وكذلك حين يصبح",
                "فضل الذكر : من قالها حين يصبح وحين يمسى كان حقا على الله أن يرضيه يوم القيامة",
                "فضل الذكر : من قالها أعتقه الله من النار",
                "فضل الذكر : من قالها حين يصبح أدى شكر يومه",
                ...
                "فضل الذكر : من قال ذلك حطت عنه خطاياه وإن كانت مثل زيد البحر"

        };

        String[] morrepeat = {"اضعط للاختفاء ^_^ ",
                "عدد التكرار : 1",
                "عدد التكرار : 3",
                "عدد التكرار : 3",
                "عدد التكرار : 3",
        ...
        for (int i =0 ; i<mormAzkar.length&&i<morfadl.length&&i<morrepeat.length;i++){

            AzkarInformation current = new AzkarInformation();

            current.zikr = mormAzkar[i];
            current.fadl = morfadl[i];
            current.repeat = morrepeat[i];
            data.add(current);
